...
namespace Base.Data.Operations.Fee {
	...
	public sealed class TournamentCreateOperationFeeParametersData : FeeParametersData {
		...
		public override ChainTypes.FeeParameters Type {
			get { return ChainTypes.FeeParameters.TournamentCreateOperation; }
		}
		...
		public static TournamentCreateOperationFeeParametersData Create( JObject value ) {
			var token = value.Root;
			var instance = new TournamentCreateOperationFeeParametersData();
