   ...
   public override void Awake() {
    ...
    void UpdateTournamentsHandler( IdObject idObject ) {
        if ( idObject.SpaceType.Equals(SpaceType.Tournament) ) {
            ...
            if ( tournament.Id.Equals( currenTournament.Id ) && tournament.State.Equals(ChainTypes.TournamentState.Concluded)) {
    ...
    void UpdateTournament( TournamentObject info ) {
        ...
        if ( info.State == ChainTypes.TournamentState.InProgress ) {
    ...
    public void ShowTournamentInfo( TournamentObject info ) {
        ...
        UpdateTournament( currenTournament );
        ApiManager.Instance.Database.GetTournamentDetails( info.Id.Id )
            .Then( detailResult => {
